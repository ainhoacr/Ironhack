...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    QuestionsViewController *questionsViewController = [[QuestionsViewController alloc]initWithDataSource:[[SurveyDataSource alloc]init]];
    
    ResultsViewController *resultsViewController = [[ResultsViewController alloc]init];
    resultsViewController.tabBarItem.title = @"Resultados";
    ...
    [tarBarController setViewControllers:@[navigationController, resultsViewController] animated:YES];
