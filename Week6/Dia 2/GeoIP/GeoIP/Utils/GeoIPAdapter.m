...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSFetchRequest *fetchRequest = [GeoIP fetchRequestWithFields:@[@"country",@"ip"] andOrders:@[@YES,@NO]];
...
- (NSFetchedResultsController *)fetchedResultsControllerWithFetchRequest:(NSFetchRequest *)fetchRequest
    ...
    NSFetchedResultsController *fetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.managedObjectContext sectionNameKeyPath:sectionNameKeyPath cacheName:[NSUUID UUID].UUIDString];
