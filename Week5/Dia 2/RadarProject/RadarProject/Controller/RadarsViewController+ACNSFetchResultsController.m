//
//  RadarsViewController+ACNSFetchResultsController.m
//  RadarProject
//
...
#import "RadarsViewController+ACNSFetchResultsController.h"
#import "RadarCell.h"

@implementation RadarsViewController (ACNSFetchResultsController)
      ...
      newIndexPath:(NSIndexPath *)newIndexPath
{
    ...
    switch(type) {
        ...
        {
            RadarCell *radarCell = (RadarCell *) [tableView cellForRowAtIndexPath:indexPath];
            radarCell.radar = [self.fetchedResultsController objectAtIndexPath:indexPath];
        }
            break;
